...
public class AppDbContext : BaseDbContext<AppUser, AppRole, IdentityUserClaim<Guid>, AppUserRole, IdentityUserLogin<Guid>, IdentityRoleClaim<Guid>, IdentityUserToken<Guid>, AppTranslation, AppTranslationString>
{
